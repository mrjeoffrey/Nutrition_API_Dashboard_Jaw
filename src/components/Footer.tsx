      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            ...
            <p className="text-gray-500 text-base">
              Making nutrition data accessible for developers and businesses worldwide.
            </p>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul role="list" className="mt-4 space-y-4">
                  <li>
                    <Link to="/docs/api" className="text-base text-gray-500 hover:text-gray-900">
                      Nutrition API
                    </Link>
                  </li>
                  <li>
                    <Link to="/docs/barcode" className="text-base text-gray-500 hover:text-gray-900">
                      Barcode Scanner
                    </Link>
                  </li>
                  <li>
              ...
              <div className="mt-12 md:mt-0">
                ...
                <ul role="list" className="mt-4 space-y-4">
                  ...
                  <li>
                    <Link to="/docs/guides" className="text-base text-gray-500 hover:text-gray-900">
                      Guides
                    </Link>
                  </li>
                  <li>
        ...
        <div className="mt-12 border-t border-gray-200 pt-8">
          <p className="text-base text-gray-400 xl:text-center">
            &copy; {new Date().getFullYear()} NutriVerse API Hub. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
